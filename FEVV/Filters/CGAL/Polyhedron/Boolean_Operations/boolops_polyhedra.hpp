...
//TODO-elo-rm  #include "Time_measure.h"
#include <chrono>
...
public:
      ...
      : m_BOOP(BOOP)
  {
...
#ifdef BOOLEAN_OPERATIONS_DEBUG
    //TODO-elo-rm  duration_Init = Timer.GetDiff();
    //TODO-elo-rm  Timer.Start();
...
#ifdef BOOLEAN_OPERATIONS_DEBUG
    //TODO-elo-rm  duration_FindCouples = Timer.GetDiff();
    //TODO-elo-rm  Timer.Start();
    ...
    if(!m_Couples.empty())
    {
...
#ifdef BOOLEAN_OPERATIONS_DEBUG
      //TODO-elo-rm  duration_ComputeIntersections = Timer.GetDiff();
      //TODO-elo-rm  Timer.Start();
      time_end = std::chrono::steady_clock::now();
      duration = time_end - time_start;
...
#ifdef BOOLEAN_OPERATIONS_DEBUG
      //TODO-elo-rm  duration_CutIntersectedFacets = Timer.GetDiff();
      //TODO-elo-rm  Timer.Start();
      time_end = std::chrono::steady_clock::now();
      duration = time_end - time_start;
...
#ifdef BOOLEAN_OPERATIONS_DEBUG
      //TODO-elo-rm  duration_PropagateFacets = Timer.GetDiff();
      //TODO-elo-rm  Timer.Start();
      time_end = std::chrono::steady_clock::now();
      duration = time_end - time_start;
...
#ifdef BOOLEAN_OPERATIONS_DEBUG
      //TODO-elo-rm  duration_delegate = Timer.GetDiff();
      //TODO-elo-rm  duration_total = Timer_total.GetDiff();
      time_end = std::chrono::steady_clock::now();
      duration = time_end - time_start;
      ...
      ofstrMS << g_out;
      //TODO-elo-rm  ofstrtime.open("output_time.txt");
      WriteData(g_out);
      ColorType();
...
private:
  ...
  //TODO-elo-rm  std::ofstream ofstrtime;
